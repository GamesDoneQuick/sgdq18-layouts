...
1. Download and extract [this custom build of OBS](https://www.dropbox.com/s/4v93ihx72kjmxw7/SGDQ-OBS-8d0d90c-fixed-websocket.zip?dl=1), which includes all the plugins we use.  
