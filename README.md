...
1. Download and extract [this custom build of OBS](https://www.dropbox.com/s/ql8y1ehcvbolzvq/SGDQ-OBS-8d0d90c.zip?dl=1), which includes all the plugins we use.  
